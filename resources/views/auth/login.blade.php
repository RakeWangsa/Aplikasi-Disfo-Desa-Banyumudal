...
<main>
   <div class="row">
      <div class="col-5 logo-login" style="background-color:aliceblue">
         <img src="{{ asset('admintemplate/img/logo-login.png') }}" style="width:500px;height:auto" alt="Logo Farmhill Group">
      </div>

      <div class="col-7 body-login" style="background-color:#12a0ff">
         <div class="container">
                           ...
                           <div class="card-body login">
                              ...
                              <form action="/login" method="post">
                                 ...
                                 <div class="form-floating">
                                    ...
                                    @error('email') is-invalid @enderror" id="email" placeholder="Email" required value="{{ old('email') }}" style="background-color:#d0ecff">
                                 ...
                                 <div class="form-floating">
                                    <input type="password" name="password" class="form-control" id="password" placeholder="Password" required style="background-color:#d0ecff">
                                 ...
                                 <div class="col-12 mt-4 mb-2">
                                    <button class="btn btn-login w-100" type="submit" style="background-color:#0099ff">
